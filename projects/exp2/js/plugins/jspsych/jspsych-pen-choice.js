...
jsPsych.plugins["pen-choice"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('pen-choice', 'stimulus', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.audio) {
      var sound = new Audio(trial.audio);
      sound.play();
    }
    ...
    function end_trial() {
      ...
      var trial_data = {
       ...
       var pen_choice_unique = {
            ...
            'images/pen_choice/green_2.png':2, 
            'images/pen_choice/green_3.png':3, 
            'images/pen_choice/green_4.png':4, 
