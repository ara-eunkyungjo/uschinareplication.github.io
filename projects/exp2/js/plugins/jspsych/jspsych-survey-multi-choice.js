...
jsPsych.plugins['survey-multi-choice'] = (function() {
      ...
      questions: {
        ...
        nested: {
          ...
          timeout: {
            ...
            pretty_name: 'Timeout',
            default: null,
            description: 'Optional timeout (in seconds) if question is not answered'
          }
        }
      },
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // set trial timeout (and redundant end trial code)
    if(trial.timeout !== null) {
      //console.log("setting timeout: "+trial.timeout);
      timeoutHandler = jsPsych.pluginAPI.setTimeout(function(){
