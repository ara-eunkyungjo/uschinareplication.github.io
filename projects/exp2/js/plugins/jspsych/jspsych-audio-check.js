...
jsPsych.plugins['audio-check'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      html += '<div id="jspsych-survey-text-'+question_index+'" class="jspsych-survey-text-question" style="margin: 1em 0em;">';
      html += '<div class="jspsych-survey-text" style="margin: 0.1em 0em;">' + question.prompt;
      if(question.audio){
        html += '   <img role="button" src="media/images/demog/audio.png" style="height:20px; width:20px" class="AR" onclick="playAudio(\'' + question.audio + '\')"/>'
      }
      html += '</div>';
