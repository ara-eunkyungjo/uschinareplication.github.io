...
jsPsych.plugins["task-instructions-audio"]  = (function() {

  var plugin = {};

  plugin.info = {
    name: 'task-instructions-audio',
    description: '',
    parameters: {
      pages: {
      ...
      audio_pages: {
        ...
        pretty_name: 'Audio pages',
        default: false,
        description: 'The audio to be played alongside visual instructions; must have same number of elements as Pages.'
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      ...
      audio = new Audio(trial.audio_pages[current_page])
