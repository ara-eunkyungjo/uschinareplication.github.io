...
jsPsych.plugins["rmts-train"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('rmts-train', 'stimuli', 'image');
  //jsPsych.pluginAPI.registerPreload('rmts-train', 'scene', 'audio');
