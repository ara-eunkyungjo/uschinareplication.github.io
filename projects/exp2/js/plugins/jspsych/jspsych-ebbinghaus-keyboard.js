...
jsPsych.plugins["ebbinghaus-keyboard"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('ebbinghaus-keyboard', 'stimulus', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html +='<div class="row">'+
           '<div class="column">'+
            '<img src= "media/images/ebbinghaus/key_m.jpg"></img>'+ 
            '</div>'+ 
            '<div class="column">'+
            '<img src= "media/images/ebbinghaus/key_z.jpg"></img>'+ 
            '</div>'+
            '</div>'
